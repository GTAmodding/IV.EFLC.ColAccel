...
BOOL APIENTRY DllMain(HMODULE /*hModule*/, DWORD reason, LPVOID /*lpReserved*/)
{
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        dw_0xF3F224 = (uint32_t)hook::pattern("A3 ? ? ? ? F3 0F 11 05 ? ? ? ? F3 0F 11 05 ? ? ? ? F3 0F 11 05").get(2).get<uint32_t>(1);
        dw_0x16D7028 = (uint32_t)hook::pattern("A1 ? ? ? ? 83 EC 1C 56 33 F6 39 70 08").get(0).get<uint32_t>(1);
        ...
        dw_0xEBB998 = (uint32_t)hook::pattern("C7 07 ? ? ? ? 74 ? 64 8B 0D 2C 00 00 00 8B 11 8B 4A 08 8B 01").get(0).get<uint32_t>(2);
        ...
        pattern = hook::pattern("50 E8 ? ? ? ? 8B 56 30");
        hbsub_BA3430.fun = injector::MakeCALL(pattern.get_first(1), sub_BA3430).get();
        pattern = hook::pattern("E8 ? ? ? ? 83 C4 08 89 46 30");
        ...
        uint32_t dw_0x1227F40 = (uint32_t)hook::pattern("B9 ? ? ? ? E8 ? ? ? ? 8B D8 33 ED 85 DB 89 5C 24 30").get(0).get<uint32_t>(1);
